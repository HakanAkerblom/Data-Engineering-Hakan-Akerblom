...
app.layout = html.Div([
    ...
    html.P("Choose number of dice and number of rolls and enjoy the results"),
    dcc.Graph(id = "dice-graph"),
    html.Button("Save dice rolls", id = "save-button"),
...
@app.callback(Output("simulation-data", "data"), Input("number-rolls", "value"), Input("number-dices", "value"))

def dice_simulation(rolls, number_dices):
